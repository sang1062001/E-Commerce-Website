...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>LOẠI SẢN PHẨM</h4></a></li>
	";
        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            <div class='col-md-4'>
                    <div class='panel panel-info'>
                        ...
                        <div class='panel-heading'>$pro_price VNĐ
                        <button pid='$pro_id' id='product' style='float:right;' class='btn btn-danger btn-xs'>Thêm vào giỏ hàng</button>
                    </div>
                    </div>
                    </div>
...
if(isset($_POST["addProduct"])){
    if (isset($_SESSION["uid"])) {
       ...
       <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
       <b>Vui lòng đăng nhập hoặc đăng ký trước khi mua sắm</b>
       </div>   
       ";
    }
        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            if (isset($_POST["get_cart_product"])) {
                ...
                <div class='row'>
                    ...
                    <div class='col-md-3'>$pro_price VNĐ</div>
                </div>
...
if($run_quey) {
    ...
    <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Đã xóa sản phẩm khỏi giỏ hàng</b>
    </div>
    ";
}
}
...
if (isset($_POST["updatproduct"])){
    ...
    if ($run_query) {
        echo "
        <div class='alert alert-success'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a><b>Cập nhật sản phẩm thành công</b>
        </div>  
        ";
    }
}
